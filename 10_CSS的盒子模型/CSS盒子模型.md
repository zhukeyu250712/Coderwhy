...
![image-20230421151414851](../pic/image-20230421151414851.png)

### 1、盒子模型（Box Model）

可以把HTML每一个元素看出一个个的盒子，可以具备这4个属性

![image-20230421151714822](../pic/image-20230421151714822.png)
...
![image-20230421152004970](../pic/image-20230421152004970.png)

在浏览器的开发工具中

![image-20230421152026144](../pic/image-20230421152026144.png)
...
![image-20230421153347501](../pic/image-20230421153347501.png)
...
![image-20230421153837636](../pic/image-20230421153837636.png)
...
- 边框颜色、宽度、样式的编写顺序任意
  ...
  ![image-20230421154134285](../pic/image-20230421154134285.png)
...
- 如果一个元素是正方形, 设置border-radius大于或等于50%时，就会变成一个圆
  - ![image-20230421155041338](../pic/image-20230421155041338.png)
...
![image-20230421165346374](../pic/image-20230421165346374.png)
...
![image-20230421165905810](../pic/image-20230421165905810.png)
...
![image-20230419224559807](../pic/image-20230419224559807.png)
...
* box-shadow属性可以设置一个或者多个阴影
  ...
  * 多个阴影之间用逗号,隔开，从前到后叠加
* <shadow>的常见格式如下
  * <img src="../pic/image-20230521203611438.png" alt="image-20230521203611438" style="zoom:80%;" />
...
- <shadow>的常见格式如下
  - ![image-20230521203944375](../pic/image-20230521203944375.png)
...
* box-sizing: content-box
  ...
  * ![image-20230521213834303](../pic/image-20230521213834303.png)
  
* box-sizing: border-box
  * 元素的实际占用宽度 = width
  * 元素的实际占用高度 = height 
  * ![image-20230521213914011](../pic/image-20230521213914011.png)
  
* IE盒子模型

  * W3C标准盒子模型
    * ![image-20230521214025833](../pic/image-20230521214025833.png)
  * IE盒子模型（IE8以下浏览器）
    * ![image-20230521214046618](../pic/image-20230521214046618.png)
  ...
  ![image-20230521214435517](../pic/image-20230521214435517.png)
...
![image-20230521221838866](../pic/image-20230521221838866.png)
...
![image-20230521224645953](../pic/image-20230521224645953.png)

这里a已经修改为inline-block

![image-20230521225343984](../pic/image-20230521225343984.png)
...
![image-20230521230101455](../pic/image-20230521230101455.png)
...
![image-20230705221137396](../pic/image-20230705221137396.png)
